...
- **amd64** — building on Vultr instance `REDACTED-VULTR-IP`
  (`REDACTED-VULTR-UUID-2`); KVM-native x86.
...
deployed to a KVM-capable x86 Vultr instance (`REDACTED-VULTR-IP`) for its timing
gate.
