...
#   nu bin/smolbsd.nu provision vultr --dry-run
#   nu bin/smolbsd.nu provision hetzner --dry-run
#   nu bin/smolbsd.nu provision hetzner --type robot --dry-run
        ...
        "provision" => {
            ...
            match $provider {
                ...
                _ => {
                    ...
                    print "  usage: nu bin/smolbsd.nu provision <vultr|hetzner> [flags...]"
                    print "  example: nu bin/smolbsd.nu provision hetzner --dry-run"
                    print "  example: nu bin/smolbsd.nu provision vultr --dry-run"
                    exit 1
                }
            }
        }
